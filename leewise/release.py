...
product_name = 'Leewise'
description = 'Leewise Server'
long_desc = '''Leewise is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'OpenERP S.A.'
author_email = 'info@leewise.in'
license = 'LGPL-3'

nt_service_name = "leewise-server-" + series.replace('~','-')
