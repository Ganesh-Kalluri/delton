...
from leewise.addons.base.tests.test_format_address_mixin import FormatAddressCase
from leewise.addons.crm.models.crm_lead import PARTNER_FIELDS_TO_SYNC, PARTNER_ADDRESS_FIELDS_TO_SYNC
from leewise.addons.crm.tests.common import TestCrmCommon, INCOMING_EMAIL
from leewise.addons.mail.tests.mail_tracking_duration_mixin_case import MailTrackingDurationMixinCase
from leewise.addons.phone_validation.tools.phone_validation import phone_format
from leewise.exceptions import UserError
from leewise.tests.common import Form, tagged, users
