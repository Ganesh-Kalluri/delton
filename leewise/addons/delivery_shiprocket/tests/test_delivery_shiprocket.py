...
from leewise.addons.delivery_shiprocket.models.shiprocket_request import ShipRocket
...
class TestDeliveryShiprocket(TransactionCase):
    ...
    def _get_expected_parcel_data(self):
        ...
        return {
            ...
            'billing_email': 'partner@leewise.in',
            ...
            'shipping_email': 'partner@leewise.in',
