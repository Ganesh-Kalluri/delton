...
class TestMailMobile(SMSCommon):
    ...
    def setUpClass(cls):
        ...
        cls.env['ir.config_parameter'].sudo().set_param('web.base.url', 'http://yourcompany.leewise.in')
    ...
    def test_override_url_in_mail(self):
        ...
        original_expected_link = 'http://yourcompany.leewise.in/mail/view?model=mail.activity&res_id=1'
...
class TestPushNotification(SMSCommon):
    ...
    def setUpClass(cls):
        ...
        sudo_icp.set_param('leewise_ocn.project_id', 'Test')
    ...
    @patch('leewise.addons.mail_mobile.models.mail_thread.iap_tools.iap_jsonrpc')
