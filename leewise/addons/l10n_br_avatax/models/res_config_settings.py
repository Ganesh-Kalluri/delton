...
from leewise.exceptions import UserError, AccessError
from leewise.tools import street_split
from leewise.tools.safe_eval import json
        ...
        if 'avalara_api_id' in result:
            ...
            if 'message' in result:
                ...
                if 'unhandled error occurred' in result['message']:
                    raise UserError(_('The Avatax platform failed to create your account. Please ensure the address on your company is correct. If it is please contact support at leewise.in/help.'))
