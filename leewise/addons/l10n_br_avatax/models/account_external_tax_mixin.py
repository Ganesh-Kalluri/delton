...
from leewise import models, fields, _, registry, api, SUPERUSER_ID
from leewise.addons.iap.tools.iap_tools import iap_jsonrpc
from leewise.exceptions import UserError, ValidationError, RedirectWarning
from leewise.tools import float_round, DEFAULT_SERVER_DATETIME_FORMAT, json_float_round

logger = logging.getLogger(__name__)

IAP_SERVICE_NAME = 'l10n_br_avatax_proxy'
DEFAULT_IAP_ENDPOINT = 'https://l10n-br-avatax.api.odoo.com'
DEFAULT_IAP_TEST_ENDPOINT = 'https://l10n-br-avatax.test.leewise.in'
    ...
    def _get_external_taxes(self):
        ...
        for document, query_result in query_results.items():
            error = self._l10n_br_avatax_handle_response(query_result, _(
                'Leewise could not fetch the taxes related to %(document)s.',
