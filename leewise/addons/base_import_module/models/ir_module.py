...
from leewise.exceptions import AccessDenied, AccessError, UserError
from leewise.modules.module import adapt_version, MANIFEST_NAMES
from leewise.osv.expression import is_leaf
from leewise.release import major_version
from leewise.tools import convert_csv_import, convert_sql_import, convert_xml_import, exception_to_unicode
from leewise.tools import file_open, file_open_temporary_directory, ormcache

_logger = logging.getLogger(__name__)

APPS_URL = "https://apps.leewise.in"
...
class IrModule(models.Model):
    ...
    def _import_module(self, module, path, force=False, with_demo=False):
        ...
        if unmet_dependencies:
            ...
            raise UserError(_("Studio customizations require the Leewise Studio app."))
    ...
    def _get_missing_dependencies(self, zip_data):
        ...
        if unavailable_modules:
            ...
            description += _(
                ...
                "https://www.leewise.in/pricing-plan for more information.\n"
                "If you need Website themes, it can be downloaded from https://github.com/leewise/design-themes.\n"
            )
        elif modules:
