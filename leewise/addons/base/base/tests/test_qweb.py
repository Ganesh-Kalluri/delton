...
from leewise.addons.base.models.ir_qweb import QWebException, render
from leewise.tools import misc, mute_logger
from leewise.tools.json import scriptsafe as json_scriptsafe
from leewise.exceptions import UserError, ValidationError, MissingError
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http://leewise.in/od">
...
class TestQWebBasic(TransactionCase):
    ...
    def test_attf_escaping_2(self):
        ...
        result = """
                <a href="/link/leewise/sub">link</a>
                <a href="/link/leewise/">link2</a>
            """
        values = {'url': 'leewise', 'other': True}
        rendered = self.env['ir.qweb']._render(t.id, values)
        self.assertEqual(rendered.strip(), result.strip())
    ...
    @mute_logger('leewise.addons.base.models.ir_qweb') # warning for template not found
