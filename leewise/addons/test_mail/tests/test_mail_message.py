...
from leewise.addons.test_mail.models.test_mail_models import MailTestSimple
from leewise.exceptions import AccessError, UserError
from leewise.tests.common import tagged, users
from leewise.tools import is_html_empty, mute_logger, formataddr
...
class TestMessageAccess(MailCommon):
    ...
    @mute_logger('leewise.addons.base.models.ir_model', 'leewise.addons.base.models.ir_rule')
    ...
    def test_mail_message_access_create_wo_parent_access(self):
        ...
        partner_1 = self.env['res.partner'].create({
            'name': 'Jitendra Prajapati (jpr-leewise)',
            'email': 'jpr@leewise.in',
        })
