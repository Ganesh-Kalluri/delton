...
from leewise import tools
from leewise.addons.mail.models.mail_mail import _UNFOLLOW_REGEX
from leewise.addons.mail.tests.common import MailCommon
from leewise.exceptions import AccessError
from leewise.tests import tagged, users
from leewise.tests.common import HttpCase
from leewise.tools import mute_logger, email_normalize, parse_contact_from_email
...
class BaseFollowersTest(MailCommon):
    ...
    @users('employee')
    @mute_logger('leewise.models.unlink')
    ...
    @mute_logger('leewise.addons.base.models.ir_model', 'leewise.models')
...
class UnfollowFromEmailTest(MailCommon, HttpCase):
    ...
    @mute_logger('leewise.addons.base.models', 'leewise.addons.mail.controllers.mail', 'leewise.http', 'leewise.models')
    ...
    @mute_logger('leewise.addons.mail.controllers.mail', 'leewise.models', 'leewise.http')
