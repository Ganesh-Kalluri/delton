...
from leewise import exceptions, _
from leewise.tools import email_normalize, pycompat

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap.leewise.in'
...
_MAIL_DOMAIN_BLACKLIST = set([
    ...
    'wp.pl', 'hotmail.it', 'live.com.mx', 'zoho.com', 'live.co.uk', 'sohu.com', 'twoomail.com', 'yahoo.com.sg', 'leewise.in', 'yahoo.com.vn',
    ...
    'bk.ru', 'mail.leewise.in', 'gmail.con', 'fiu.edu', 'gmal.com', 'useemlikefun.com', 'google.com', 'trbvn.com', 'yopmail.com', 'ya.ru',
