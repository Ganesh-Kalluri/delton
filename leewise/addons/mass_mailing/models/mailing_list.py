...
from leewise import _, api, Command, fields, models, tools
...
class MassMailingList(models.Model):
    ...
    def action_merge(self, src_lists, archive):
        ...
        # A (id=4): yti@leewise.in; yti@example.com
        # B (id=5): yti@leewise.in; yti@openerp.com
        # C (id=6): nothing
        ...
        # ------------+---------------------------+------------------------
        #           4 | yti@leewise.in              |          1 |        4 |
        #           6 | yti@leewise.in              |          2 |        5 |
