...
import {
    ...
    pasteText,
    pasteHtml,
    pasteLeewiseEditorHtml,
} from "../utils.js";
import { CLIPBOARD_WHITELISTS, setSelection } from "../../src/LeewiseEditor.js";
...
describe('Copy', () => {
    ...
    describe('range not collapsed', async () => {
        it('should copy a selection as text/plain, text/html and text/leewise-editor', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/leewise-editor')).to.be.equal('<p>bcd</p>');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/leewise-editor')).to.be.equal('<p>abc<br>efg</p>');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/leewise-editor')).to.be.equal('<table><tbody><tr><td><ul><li>a</li><li>b</li><li>c</li></ul></td><td><br></td></tr></tbody></table>');
                },
            });
        });
        it('should wrap the selected text with clones of ancestors up to a block element to keep styles', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/leewise-editor')).to.be.equal('<p><span style="font-size: 16px;">Test</span> <span style="font-size: 48px;"><font style="color: rgb(255, 0, 0);">Test</font></span></p>');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/leewise-editor')).to.be.equal('<p><strong><em><u><font class="text-o-color-1">there</font></u></em></strong></p>');
                },
            });
        });
        it('should copy the selection as a single list item', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/leewise-editor')).to.be.equal('<li>First</li>');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/leewise-editor')).to.be.equal('<li>List</li>');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/leewise-editor')).to.be.equal('<li><span style="font-size: 48px;"><font style="color: rgb(255, 0, 0);">First</font></span></li>');
                },
            });
        })
        it('should copy the selection as a list with multiple list items', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/leewise-editor')).to.be.equal('<ul><li>First</li><li>Second</li></ul>');
                },
            });
        });
    });
...
describe('Cut', () => {
    ...
    describe('range not collapsed', async () => {
        it('should cut a selection as text/plain, text/html and text/leewise-editor', async () => {
            await testEditor(BasicEditor, {
                contentBefore: '<p>a[bcd]e</p>',
                stepFunction: async editor => {
                    const clipboardData = new DataTransfer();
...
describe('Paste', () => {
        ...
        describe('range collapsed', async () => {
            ...
            it('should replace link for new content when pasting in an empty link', async () => {
                ...
                await testEditor(BasicEditor, {
                    contentBefore: '<p>xy<a href="#" oe-zws-empty-inline="">\u200B[]</a>z</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'http://leewise.in');
                    },
                    contentAfter: '<p>xy<a href="http://leewise.in">http://leewise.in</a>[]z</p>',
                });
                const imageUrl = 'https://download.leewisecdn.com/icons/website/static/description/icon.png';
                await testEditor(BasicEditor, {
                    contentBefore: '<p>xy<a href="#" oe-zws-empty-inline="">\u200B[]</a>z</p>',
                    stepFunction: async editor => {
            ...
            it('should paste and transform plain text content over an empty link', async () => {
                await testEditor(BasicEditor, {
                    ...
                    stepFunction: async editor => {
                        await pasteText(editor, 'abc www.leewise.in xyz');
                    },
                    contentAfter: '<p>abc <a href="http://www.leewise.in">www.leewise.in</a> xyz[]</p>',
                });
                await testEditor(BasicEditor, {
                    contentBefore: '<p><a href="#">[]\u200B</a></p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'leewise.in\ngoogle.com');
                    },
                    contentAfter: '<p style="margin-bottom: 0px;"><a href="http://leewise.in">leewise.in</a></p>' +
            ...
            it('should paste html content over an empty link', async () => {
                await testEditor(BasicEditor, {
                    contentBefore: '<p><a href="#">[]\u200B</a></p>',
                    stepFunction: async editor => {
                        await pasteHtml(editor, '<a href="www.leewise.in">leewise.in</a><br><a href="www.google.com">google.com</a>');
                    },
                    contentAfter: '<p><a href="www.leewise.in">leewise.in</a><br><a href="www.google.com">google.com</a>[]</p>',
                });
            });
            it('should paste and transform URL among text', async () => {
                const url = 'https://www.leewise.in';
                const imgUrl = 'https://download.leewisecdn.com/icons/website/static/description/icon.png';
        ...
        describe('range not collapsed', async () => {
            ...
            it('should restore selection when pasting plain text followed by UNDO', async () => {
                ...
                await testEditor(BasicEditor, {
                    contentBefore: '<p>[abc]</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'www.leewise.in');
                        editor.historyUndo();
                    },
                    contentAfter: '<p>[abc]</p>',
                });
                await testEditor(BasicEditor, {
                    contentBefore: '<p>[abc]</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'def www.leewise.in xyz');
                        editor.historyUndo();
                    },
                    contentAfter: '<p>[abc]</p>',
                });
            ...
            it('should paste and transform plain text content over a link if all of its contents is selected', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p><a href="http://www.leewise.in">www.leewise.in</a>[]</p>',
                });
                await testEditor(BasicEditor, {
                    contentBefore: '<p><a href="#">[xyz]</a></p>',
                    stepFunction: async editor => {
        ...
        describe('range collapsed', async () => {
            it('should paste and transform an image URL in a p', async () => {
                await testEditor(BasicEditor, {
                    contentBefore: '<p>ab[]cd</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'https://download.leewisecdn.com/icons/website/static/description/icon.png');
                        // Ensure the powerbox is active
                        window.chai.expect(editor.powerbox.isOpen).to.be.true;
                        // Force powerbox validation on the default first choice
                        await editor.powerbox._pickCommand();
                    },
                    contentAfter: '<p>ab<img src="https://download.leewisecdn.com/icons/website/static/description/icon.png">[]cd</p>',
                });
            });
            it('should paste and transform an image URL in a span', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p>a<span class="a">b<img src="https://download.leewisecdn.com/icons/website/static/description/icon.png">[]c</span>d</p>',
                });
            });
            it('should paste and transform an image URL in an existing link', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p>a<a href="http://existing.com">b<img src="https://download.leewisecdn.com/icons/website/static/description/icon.png">[]c</a>d</p>',
                });
            });
            it('should paste an image URL as a link in a p', async () => {
                const url = 'https://download.leewisecdn.com/icons/website/static/description/icon.png';
                await testEditor(BasicEditor, {
                    contentBefore: '<p>[]</p>',
                    stepFunction: async editor => {
    ...
    describe('Leewise editor own html', () => {
        it('should paste html as is', async () => {
            await testEditor(BasicEditor, {
                contentBefore: '<p>a[]b</p>',
                stepFunction: async editor => {
                    await pasteLeewiseEditorHtml(editor, '<div class="custom-paste">b</div>');
                },
        ...
        it('should not paste unsafe content', async () => {
            await testEditor(BasicEditor, {
                contentBefore: '<p>a[]b</p>',
                stepFunction: async editor => {
                    await pasteLeewiseEditorHtml(editor, `<script>console.log('xss attack')</script>`);
                },
    ...
    describe('editable in iframe', () => {
        it('should paste leewise-editor html', async () => {
            // Setup
            ...
            const clipboardData = new DataTransfer();
            clipboardData.setData('text/leewise-editor', '<p>text<b>bold text</b>more text</p>');
