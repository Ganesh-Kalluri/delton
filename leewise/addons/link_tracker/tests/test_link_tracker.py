...
from leewise.addons.link_tracker.tests.common import MockLinkTracker
from leewise.exceptions import UserError
from leewise.tests import common, tagged
...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    ...
    def setUp(self):
        ...
        self._web_base_url = 'https://test.leewise.in'
    ...
    def test_create(self):
        ...
        self.assertEqual(
            ...
            ['http://leewise.in', 'http://example.com', 'http://test.example.com'],
        )
