...
from leewise import api, fields, models, _, _lt, Command
from leewise.addons.iap.tools import iap_tools
from leewise.exceptions import AccessError
from leewise.tools import float_compare, mute_logger
from leewise.tools.misc import clean_context, formatLang
...
PARTNER_AUTOCOMPLETE_ENDPOINT = 'https://partner-autocomplete.leewise.in'
OCR_VERSION = 122
