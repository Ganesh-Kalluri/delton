...
from leewise.addons.hw_drivers.main import iot_devices, manager
...
class ConnectionManager(Thread):
    ...
    def run(self):
        if not helpers.get_leewise_server_url() and not helpers.access_point():
    ...
    def _connect_box(self):
        ...
        try:
            ...
            req = requests.post('https://iot-proxy.leewise.in/leewise-enterprise/iot/connect-box', json=data, verify=False)
            ...
            _logger.error('Could not reach iot-proxy.leewise.in')
