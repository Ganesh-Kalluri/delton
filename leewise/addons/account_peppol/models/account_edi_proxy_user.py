...
from leewise import _, fields, models, modules, tools
from leewise.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from leewise.addons.account_peppol.tools.demo_utils import handle_demo
...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _get_proxy_urls(self):
        ...
        urls['peppol'] = {
            ...
            'test': 'https://peppol.test.leewise.in',
            'demo': 'demo',
        }
        return urls
