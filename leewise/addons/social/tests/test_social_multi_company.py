...
from leewise.addons.social.tests import common
from leewise.addons.social.tests.tools import mock_void_external_calls
from leewise.exceptions import AccessError, ValidationError
...
class TestSocialMultiCompany(common.SocialCase):
    ...
    def test_social_post_click_count(self):
        ...
        url = 'https://leewise.in/test/click/count/computation'
        message = f"""
            Hi social users :)
            Visit {url}
        """
