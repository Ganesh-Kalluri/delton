/** @leewise-module **/
    ...
    wTourUtils.registerWebsitePreviewTour("website_form_editor_tour", {
        ...
        ...addExistingField('email_cc', 'text', 'Test conditional visibility', false, {visibility: CONDITIONALVISIBILITY, condition: 'leewise'}),
        {
...

        {
            ...
            run: () => {
                ...
                wysiwyg.leewiseEditor.historyStep(true);
            },
        },
