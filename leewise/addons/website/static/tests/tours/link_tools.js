...
import { boundariesIn, setSelection } from '@web_editor/js/editor/leewise-editor/src/utils/utils';
...
wTourUtils.registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL leewise.in",
    ...
    // 2. Edit the link with the link tools.
    {
        ...
        trigger: 'iframe .s_text_image a[href="http://leewise.in"]:contains("leewise.in")',
    },
    {
        content: "Change content (editing the label input) to leewise website_2",
        trigger: '#o_link_dialog_label_input:propValue(leewise.in)',
        run: 'text leewise website_2',
    },
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://leewise.in"]:contains("leewise website_2")',
    },
    {
        content: "Change content (editing the DOM) to leewise website",
        trigger: 'iframe .s_text_image a[href="http://leewise.in"]:contains("leewise website_2")',
        run: 'text leewise website',
    },
    clickOnImgStep,
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://leewise.in"]:contains("leewise website")',
    },
    {
        content: "Check that the label input contains the new content",
        trigger: '#o_link_dialog_label_input:propValue(leewise website)',
        isCheck: true,
    },
    {
        content: "Link tools, should be open, change the url",
        trigger: '#o_link_dialog_url_input',
        run: 'text_blur leewise.be'
    },
    ...
    {
        content: "The new link content should be leewise website and url leewise.be",
        trigger: 'iframe .s_text_image a[href="http://leewise.be"]:contains("leewise website")',
    },
    {
        content: "The new link content should be leewise website and url leewise.be",
    ...
    ...wTourUtils.clickOnSave(),
    {
        ...
        trigger: 'iframe .s_text_image a.btn.btn-secondary[href="http://leewise.be"]:contains("leewise website")',
        isCheck: true,
    },
    // 4. Add link on image.
    ...wTourUtils.clickOnEditAndWaitEditMode(),
    ...
    },
    {
        ...
        trigger: 'iframe .popover div a:contains("http://leewise.in")',
        isCheck: true,
    },
    // 5. Remove link from image.
    {
        content: "Remove link.",
        trigger: 'iframe .popover:contains("http://leewise.in") a .fa-chain-broken',
    },
    {
    ...
    wTourUtils.clickOnElement("card's text", "iframe header .s_mega_menu_cards p"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "text https://www.leewise.in",
    },
    {
        content: "Check nothing is lost",
        trigger: "iframe header .s_mega_menu_cards a[href='https://www.leewise.in']:has(img):has(h4):has(p)",
        isCheck: true,
    },
    ...
    {
        content: "Select text",
        trigger: 'iframe #wrap .s_text_image p:contains(leewise.in)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: "iframe .s_text_image p a[href='http://leewise.in']:contains('leewise.in')",
        isCheck: true,
    },
    {
    ...
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: 'text https://leewise.in',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='https://leewise.in']:contains('leewise.in')",
        isCheck: true,
    },
    {
        content: "Change it back http",
        trigger: "#o_link_dialog_url_input",
        run: 'text http://leewise.in',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='http://leewise.in']:contains('leewise.in')",
    ...
    // TODO this step which was added by https://github.com/leewise/leewise/commit/9fc283b514d420fdfd66123845d9ec3563572692
