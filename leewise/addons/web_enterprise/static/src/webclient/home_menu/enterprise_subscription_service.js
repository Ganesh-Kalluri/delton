...
import { Component, xml, useState } from "@leewise/owl";
...
export class SubscriptionManager {
    ...
    async buy() {
        ...
        browser.location = `https://www.leewise.in/leewise-enterprise/upgrade?num_users=${nbUsers}`;
    }
    /**
    ...
    async renew() {
        ...
        const url = "https://www.leewise.in/leewise-enterprise/renew";
    ...
    async upsell() {
        ...
        const url = "https://www.leewise.in/leewise-enterprise/upsell";
        const contractQueryString = enterpriseCode ? `&contract=${enterpriseCode}` : "";
