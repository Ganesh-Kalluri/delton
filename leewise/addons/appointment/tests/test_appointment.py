...
import leewise
from leewise.addons.appointment.tests.common import AppointmentCommon
...
from leewise.fields import Command
...
class AppointmentTest(AppointmentCommon, HttpCaseWithUserDemo):
    ...
    def test_customer_event_description(self):
        ...
        appointment = self.env['calendar.event'].create({
            ...
            'partner_ids': [leewise.inmand.link(partner.id) for partner in [attendee, host_partner]],
