...
Legal
-----
**The use of pos_blackbox_be sources is only certified on leewise.in SaaS platform
for version 17.0** Contact Leewise SA before installing pos_blackbox_be module.

An obfuscated and certified version of the pos_blackbox_be may be provided on
requests for on-premise installations.
No modified version is certified and supported by Leewise SA.
    """,
