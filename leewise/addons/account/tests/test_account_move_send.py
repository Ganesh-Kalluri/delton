...
from leewise.tools import formataddr, mute_logger
...
class TestAccountComposerPerformance(AccountTestInvoicingCommon, MailCommon):
    ...
    @users('user_account')
    @warmup
    @mute_logger('leewise.addons.mail.models.mail_mail', 'leewise.models.unlink')
...
class TestAccountMoveSend(TestAccountMoveSendCommon):
    ...
    def test_link_pdf_webservice_fails_after(self):
        ...
        # Process.
        with patch(
                'leewise.addons.account.wizard.account_move_send.AccountMoveSend._call_web_service_after_invoice_pdf_render',
    ...
    def test_link_pdf_webservice_fails_before(self):
        ...
        # Process.
        with patch(
                'leewise.addons.account.wizard.account_move_send.AccountMoveSend._call_web_service_before_invoice_pdf_render',
    ...
    def test_cron_notifications(self):
        ...
        sp_partner_2 = self.env['res.partner'].create({'name': 'Partner 2', 'email': 'test@test.leewise.in'})
        ...
        with patch(
            'leewise.addons.account.wizard.account_move_send.AccountMoveSend._hook_invoice_document_before_pdf_report_render',
