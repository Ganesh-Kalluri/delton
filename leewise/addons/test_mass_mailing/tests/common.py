...
from leewise.addons.phone_validation.tools import phone_validation

from leewise.addons.mass_mailing_sms.tests.common import MassSMSCommon
...
<t t-set="httpurl" t-value="'https://www.leewise.eu'"/>f
<span>Website0: <a id="url0" t-attf-href="https://www.leewise.tz/my/{{object.name}}">https://www.leewise.tz/my/<t t-out="object.name"/></a></span>
<span>Website1: <a id="url1" href="https://www.leewise.be">https://www.leewise.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test@leewise.in">test@leewise.in</a></span>
<p>Stop spam ? <a id="url8" role="button" href="/unsubscribe_from_list">Ok</a></p>
        ...
        cls.mailing_sms = cls.env['mailing.mailing'].with_user(cls.user_marketing).create({
            ...
            'body_plaintext': 'Dear {{object.display_name}} this is a mass SMS with two links http://www.leewise.in/smstest and http://www.leewise.in/smstest/{{object.id}}',
            'sms_force_send': True,
