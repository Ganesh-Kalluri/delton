...
from leewise.addons.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
from leewise.addons.test_mass_mailing.tests.common import TestMassMailCommon
from leewise.tests import tagged
from leewise.tests.common import users
from leewise.tools import mute_logger, email_normalize
...
class TestMassMailing(TestMassMailCommon):
    ...
    def test_mailing_gateway_update(self):
        ...
        self.assertMailTraces(
            ...
            mailing, recipients,
            mail_links_info=[[
                ('url0', 'https://www.leewise.tz/my/%s' % record.name, True, {}),
                ...
                ('url7', 'mailto:test@leewise.in', False, {}),
        ...
        # simulate a click
        self.gateway_mail_click(mailing, recipients[0], 'https://www.leewise.be')
