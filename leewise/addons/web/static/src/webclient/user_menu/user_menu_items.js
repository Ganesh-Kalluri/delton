...
import { Component, markup } from "@leewise/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.leewise.in/documentation/17.0";
    return {
        type: "item",
        id: "documentation",
...
function leewiseAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My leewise.in account"),
        callback: () => {
            env.services
                ...
                .catch(() => {
                    browser.open("https://www.leewise.in/account", "_blank");
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("leewise_account", leewiseAccountItem)
