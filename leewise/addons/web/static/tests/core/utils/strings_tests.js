...
QUnit.module("utils", () => {
    ...
    QUnit.test("escapeRegExp", (assert) => {
        ...
        assert.deepEqual(escapeRegExp("[wowl]"), "\\[wowl\\]");
        assert.deepEqual(escapeRegExp("[wowl.leewise]"), "\\[wowl\\.leewise\\]");
        assert.deepEqual(
            escapeRegExp("^leewise.define([.]*)$"),
            "\\^leewise\\.define\\(\\[\\.\\]\\*\\)\\$"
        );
        assert.deepEqual(
            escapeRegExp("[.*+?^${}()|[]\\"),
    ...
    QUnit.test("escape", (assert) => {
        ...
        assert.strictEqual(
            escape(`<a href="https://www.leewise.in">leewise<a>`),
            `&lt;a href=&quot;https://www.leewise.in&quot;&gt;leewise&lt;a&gt;`
        );
        assert.strictEqual(
            escape(`<a href='https://www.leewise.in'>leewise<a>`),
            `&lt;a href=&#x27;https://www.leewise.in&#x27;&gt;leewise&lt;a&gt;`
        ...
        assert.strictEqual(
            escape("<a href='https://www.leewise.in'>Leewise`s website<a>"),
            `&lt;a href=&#x27;https://www.leewise.in&#x27;&gt;Leewise&#x60;s website&lt;a&gt;`
        );
    });
    ...
    QUnit.test("isEmail", (assert) => {
        ...
        assert.notOk(isEmail("test@leewise"));
        assert.notOk(isEmail("test@leewise@leewise.in"));
        assert.notOk(isEmail("te st@leewise.in"));

        assert.ok(isEmail("test@leewise.in"));
    });
});
