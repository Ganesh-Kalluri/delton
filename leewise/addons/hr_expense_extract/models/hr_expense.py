...
class HrExpense(models.Model):
    ...
    def _contact_iap_extract(self, pathinfo, params):
        ...
        endpoint = self.env['ir.config_parameter'].sudo().get_param('iap_extract_endpoint', 'https://extract.api.leewise.in')
...
<p>Snap pictures of your receipts and let Leewise<br/> automatically create expenses for you.</p>
<p class="d-none d-md-block">
    <a href="https://apps.apple.com/be/app/leewise/id" target="_blank" class="o_expense_mobile_app">
        <img alt="Apple App Store" class="img img-fluid h-100 o_expense_apple_store" src="/hr_expense/static/img/app_store.png"/>
    </a>
    <a href="https://play.google.com/store/apps/details?id=com.leewise.mobile" target="_blank" class="o_expense_mobile_app">
