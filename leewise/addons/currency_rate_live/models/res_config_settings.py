...
from leewise.addons.account.tools import LegacyHTTPAdapter
from leewise.exceptions import UserError
from leewise.tools import DEFAULT_SERVER_DATE_FORMAT
...
class ResCompany(models.Model):
    ...
    def _generate_currency_rates(self, parsed_data):
        ...
        exchange rate of their main currency equal to one in Leewise.
        """
    ...
    def _parse_nbp_data(self, available_currencies):
        """ This method is used to update the currencies by using NBP (National Polish Bank) service API.
            ...
            Source: https://apps.leewise.in/apps/modules/14.0/trilab_live_currency_nbp/
