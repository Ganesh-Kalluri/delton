...
from leewise.tools.safe_eval import safe_eval

DEFAULT_ENDPOINT = 'https://iap-snailmail.leewise.in'
...
class SnailmailLetter(models.Model):
    ...
    def _get_error_message(self, error):
        ...
        if error == 'TRIAL_ERROR':
            ...
            return _('You don\'t have an IAP account registered for this service.<br>Please go to <a href=%s target="new">iap.leewise.in</a> to claim your free credits.', link)
