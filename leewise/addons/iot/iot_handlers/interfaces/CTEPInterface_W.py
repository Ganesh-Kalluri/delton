...
from leewise.addons.hw_drivers.tools.helpers import download_from_url, unzip_file

libPath = Path('leewise/addons/hw_drivers/iot_handlers/lib')
easyCTEPPath = libPath / 'ctep_w/libeasyctep.dll'
zipPath = str(libPath / 'ctep_w.zip')

if not easyCTEPPath.exists():
    download_from_url('http://nightly.leewise.in/master/posbox/iotbox/worldline-ctepv23_02_w.zip', zipPath)
