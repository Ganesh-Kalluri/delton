...
import leewise
from leewise.loglevels import ustr
...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~leewise.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within leewise, this assumption is certain to fall short for international
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@leewise.in
    * Output: "Admin" <notifications@leewise.in>
    """
